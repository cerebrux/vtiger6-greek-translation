...
Η τρέχουσα έκδοση είναι για την έκδοση 6.1.0 του vTiger:
* [6.1.0-1521] [3]
...
* Βήμα 1.
Αφού κατεβάσετε το αρχείο zip/tar.gz [6.0.0-2112] [6] κάντε εξαγωγή και έπειτα δημιουργήστε ένα νέο zip επιλέγοντας τα αρχεία και φακέλους manifest.xml modules και cron
