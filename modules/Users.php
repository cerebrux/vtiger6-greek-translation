...
$languageStrings = array(
	...
	//MyPreference Blocks
	'LBL_MY_PREFERENCES'  =>  'Οι Προτημίσεις Μου',
	...
	'LBL_TAG_CLOUD_DISPLAY' => 'Εμφάνιση Tag Cloud', // Tag Cloud - Συνεφάκι με λέξεις κλειδιά

	//MyPreference Fields
	'Role' => 'Ρόλος',
	'Admin' => 'Διαχειριστής',
	'User Name' => 'Όνομα Χρήστη',
	'Default Activity View' => 'Χρονική Εκκίνηση Ημερολογιού απο:',
	'Default Lead View' => 'Προεπιλεγμένη Προβολή Προοπτικής',
	'Title' => 'Τίτλος',
	'Office Phone' => 'Τηλέφωνο Γραφείου',
	'Department' => 'Τμήμα',
	'Reports To' => 'Αναφέρετε στόν',
	...
	'LBL_LOGIN_HISTORY' => 'Ιστορικό Συνδεσιμότητας',
	'LBL_USERDETAIL_INFO' => 'Προβολή Πληροφοριών Χρήστη',
	'LBL_DELETE_GROUP' => 'Διαγραφή Ομάδας',
	'LBL_DELETE_GROUPNAME' => 'Η Ομάδα που Πρόκειται να Διαγραφεί',
	'LBL_TRANSFER_GROUP' => 'Μεταφορά Ιδιοκτησίας σε/στόν: ',
	...
	'Asterisk Extension'  => 'Επέκταση Asterisk', // Εννοεί Asterisk τηλεφωνικό κέντρο
	'Receive Incoming Calls' => 'Αποδοχή Εισερχόμενων Κλήσεων',
	'Webservice Access Key' => 'Κλειδάριθμος Διαδικτιακής Υπηρεσίας',
	'Language' => 'Γλώσσα',
	'Theme' => 'Εμφάνιση',
	'Time Zone' => 'Ζώνη Ώρας',
	'Decimal Separator' => 'Δεκαδικός Διαχωριστής',
	'Digit Grouping Pattern' => 'Πρότυπο Ομαδοπίσης Ψηφίου',
	'Digit Grouping Separator' => 'Διαχωριστικό Ομαδοπίσης Ψηφίου',
	'Symbol Placement' => 'Τοποθέτηση Συβόλου',
	...
	//Time zones-Dont change any value Δεν έχει νόημα να μεταφραστούν
