...
$languageStrings = array(
	...
	'Asterisk Extension' => 'Επέκταση Asterisk',
 	...
 	'Language' => 'Γλώσσα',
	'LBL_ABOUT_ME'		=>	'Σχετικά με εμένα',
	'LBL_ACTIVE_USERS' => 'Ενεργοί Χρήστες',
	'LBL_ADD_RECORD' => 'Προσθήκη Χρήστη',
 	'LBL_ADDRESS_INFORMATION' => 'Διεύθυνση Χρήστη',
	'LBL_ALL_FIELDS_BELOW_ARE_REQUIRED'		=>	'(Όλα τα παρακάτω πεδία είναι απαραίτητα)',
	'LBL_ALMOST_THERE'	=>	'Σχεδόν έτοιμοι!',
	'LBL_BASE_CURRENCY'		=> 'Νόμισμα Βάσης',
	'LBL_CHANGE_PASSWORD' => 'Αλλαγή Κωδικού',
	'LBL_CHOOSE_BASE_CURRENCY'	=> 'Επιλέξτε Νόμισμα Βάσης',
	'LBL_CHOOSE_DATE_FORMAT'=> 'Επιλέξτε Μορφή Ημερολογίου',
	'LBL_CHOOSE_LANGUAGE'	=> 'Επιλέξτε Γλώσσα',
	'LBL_CHOOSE_TIMEZONE'	=> 'Επιλέξτε Ζώνη ώρας',
	...
	'LBL_DATE_FORMAT'		=> 'Μορφή Ημερολογίου',	
	...
	'LBL_DELETE_USER_PERMANENTLY' => 'Μόνημη διαγραφή χρήστη',
	...
	'LBL_INACTIVE_USERS' => 'Ανενεργοί χρήστες',
	...
	'LBL_OPERATING_CURRENCY'	=> 'Το Νόμισμα βάσης δεν μπορεί να τροποποιηθεί αργότερα. Επιλέξτε το νόμισμα που χρησιμοποιείτε',
	'LBL_PHONE'	=> 'Τηλέφωνο',
	...
	'LBL_TRANSFER_OWNERSHIP' => 'Μεταφορά ιδιοκτησίας δεδομένων',
	...
	'LBL_USER_DELETED_SUCCESSFULLY' => 'Ο χρήστης διαγράφηκε με επιτυχία',
	...
	'LBL_WE_PROMISE_TO_KEEP_THIS_PRIVATE'	=>	'(Υποσχόμαστε να το κρατήσουμε ιδιωτικό)',
 	'LBL_WHERE_ARE_YOU_FROM' =>	'Απο πού είστε;', 
	'LBL_YOUR_CONTACT_NUMBER' => 'Τηλ. Αρ. Επικοινωνίας', 
	'Number Of Currency Decimals' => 'Αριθμός Δεκαδικών συναλλάγματος',
 	...
 	'Password' => 'Κωδικός',
 	'Receive Incoming Calls' => 'Αποδοχή Εισερχόμενων Κλήσεων',
	...
	'Theme' =>  'Εμφάνιση',
 	...
 	'Yahoo id' => 'Yahoo id', // id - Ταυτότητα
