...
$languageStrings = array(
	...
	'User Image' => 'Ανέβασμα Φωτογραφίας',
	'Date Format' => 'Τύπος Ημερομηνίας',
	'Tag Cloud' => 'Tag Cloud',
	'Signature' => 'Υπογραφή',
	...
	'LBL_DELETE_GROUP' => 'Διαγραφεί Ομάδος',
	...
	'LBL_PROFILE_TO_BE_DELETED' => 'Το Προφίλ που Πρόκειται να Διεγραφεί',
	'INTERNAL_MAIL_COMPOSER' => 'Εσωτερική Σύνθεση Ηλ.Μηνύματος',
	'Asterisk Extension'  =>  'Επέκταση Αστερίσκου',
	...
	'LBL_EMAIL_SEND' => 'Σάς Έχουμε Αποστείλει Email για Τήν Ανάκτηση του Κωδικόυ Πρόσβασης σας.',
	...
	'LBL_USER_TO_BE_DELETED' => 'Ο Χρήστης Πρόκειται να Διεγραφεί',
);
