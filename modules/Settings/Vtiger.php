...
$languageStrings = array(
	...
	'LBL_OPTIONS1'=>'Αποστολή emails από τον δικό σας mail server<br>
					- Εισαγωγή στοιχείων λογαριασμού SMTP (Όνομα Διακομιστή, Όνομα Χρήστη, Κωδικός) για τον ίδιο λογαριασμό όπως εισήχθη στο ΑΠΟ email.',
	'LBL_OPTIONS2'=>"Προσθήκη του od1.vtiger.com ως πιστοποιημένου αποστολέα από το δικό σας domain.<br>
	...
	'LBL_LOGIN_HISTORY_DETAILS' => 'Ιστορικό Συνδέσεων',
