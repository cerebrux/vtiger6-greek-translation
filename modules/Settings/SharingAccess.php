...
$languageStrings = array(
	...
	'LBL_CAN_ACCESSED_BY' => 'Μπορεί να ανατεθεί απο',
	...
	'LBL_WITH_PERMISSIONS' => 'Με Διακαιώματα',
	'LBL_APPLY_NEW_SHARING_RULES' => 'Εφαρμογή των νέων κανόνων Διαμοιρασμου',
	'LBL_READ' => 'Ανάγνωση',
...
$jsLanguageStrings = array(
	...
	'JS_DEPENDENT_PRIVILEGES_SHOULD_CHANGE' => 'Οι Πρόσβαση σε Ευκαιρίες, Αιτήματα, Προσφορές, Εντολές Πωλήσεων & Τιμολόγια πρέπει να τεθούν σε Ιδιωτικό όταν η Πρόσβαη Οργανισμών έχει τεθεί σε Ιδιωτικό',
);
