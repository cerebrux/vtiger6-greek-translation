...
$languageStrings = array(
	...
	//Edit view
	'LBL_STEP_1' => 'Βήμα 1',
	'LBL_ENTER_BASIC_DETAILS_OF_THE_WORKFLOW' => 'Εισάγετε βασικά στοιχεία της ροής εργασίας',
	...
	'MANUAL'                       => 'Σύστημα',
	'SCHEDULE_WORKFLOW'            => 'Προγραμματισμένη Ροή Ενεργειών',
	'ADD_CONDITIONS'               => 'Προσθήκη Προϋποθέσεις',
	'ADD_TASKS'                    => 'Προσθήκη Εργασίες',
	...
	'LBL_CREATED_IN_OLD_LOOK_CANNOT_BE_EDITED' => 'Αυτή η ροή εργασίας δημιουργήθηκε σε παλαιότερη εμφάνιση. Όροι δημιουργήθηκαν σε παλαιότερες ματιά δεν μπορεί να επεξεργαστεί. Μπορείτε να επιλέξετε να αναδημιουργήσει τις προϋποθέσεις, ή χρησιμοποιήστε τις υπάρχουσες συνθήκες, χωρίς να αλλάζει τους.',
	...
	'LBL_ADD_TASKS_FOR_WORKFLOW'   => 'Προσθήκη εργασίας για ροές εργασίας',
