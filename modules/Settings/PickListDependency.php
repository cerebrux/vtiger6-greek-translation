...
$languageStrings = array(
	...
	'LBL_CONFIGURE_DEPENDENCY_HELP_2' => "Αν θέλετε να δείτε ή να αλλάξετε τη διάταξη για τις άλλες τιμές της λίστας επιλογών πεδίου πηγής, <br/> μπορείτε να επιλέξετε τις τιμές κάνοντας κλικ στο <b>'Επιλέξτε τιμές Πηγής'</b> κουμπί στη δεξιά πλευρά",
